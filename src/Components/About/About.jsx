...
const About = () => {
  return (
    <>
      <h1 className="about-kruba"><span>About</span> Me</h1>
      <div className="about-content">
        <img src={krubaImg} className="about-Img"></img>
        <p className="about-bio">
          Hi, I'm a Front-end Developer, Graphic Designer, and Motion Designer.{" "}
          <br></br>
          ...
          <p className="about-bio">
            ...
            Figma. <br></br>
            My work always aims to convey meaningful ideas and deliver top-notch
            services.
